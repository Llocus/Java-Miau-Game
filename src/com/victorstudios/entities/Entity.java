...
public class Entity {
	...
	public static BufferedImage GUN_DOWN = Game.spritesheet.getSprite(144, 16, 16, 16);
	public static BufferedImage GUN_ParadoBaixo = Game.spritesheet.getSprite(144, 32, 16, 16);
